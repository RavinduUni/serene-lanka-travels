...
export const mainNav = [
  ...
  },
  {
    ...
    children: [
      { label: "Popular Sri Lanka Tours", href: "/sri-lanka-itineraries/popular" },
      { label: "Round Tours", href: "/sri-lanka-itineraries/round-tours" },
      { label: "Luxury Tours", href: "/sri-lanka-itineraries/luxury-tours" },
      { label: "Honeymoon Tours", href: "/sri-lanka-itineraries/honeymoon-tours" },
      { label: "Family Tours", href: "/sri-lanka-itineraries/family-tours" },
      { label: "Wildlife & Safari Tours", href: "/sri-lanka-itineraries/wildlife-safari-tours" },
      { label: "Adventure Tours", href: "/sri-lanka-itineraries/adventure-tours" },
      { label: "Cultural & Heritage Tours", href: "/sri-lanka-itineraries/cultural-heritage-tours" },
      { label: "Beach Tours", href: "/sri-lanka-itineraries/beach-tours" },
      { label: "Nature Tours", href: "/sri-lanka-itineraries/nature-tours" },
      { label: "North & East Sri Lanka Tours", href: "/sri-lanka-itineraries/north-east-tours" },
      { label: "Budget Tours", href: "/sri-lanka-itineraries/budget-tours" },
      { label: "Ramayana Tours", href: "/sri-lanka-itineraries/ramayana-tours" },
      { label: "Whale Watching Tours", href: "/sri-lanka-itineraries/whale-watching-tours" },
    ],
  },
  {
    label: "Tailor-Made",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Experiences", href: "/discover-sri-lanka/experiences" },
      { label: "Sri Lanka Travel Guide", href: "/discover-sri-lanka/travel-guide" },
      { label: "Travel Tips", href: "/discover-sri-lanka/travel-tips" },
      { label: "Best Time to Visit Sri Lanka", href: "/discover-sri-lanka/best-time-to-visit" },
      { label: "Visa Information", href: "/discover-sri-lanka/visa-information" },
    ],
  },
