...
/**
 * Experience card – mirrors DestinationCard exactly (image top, name, blurb, pill CTA).
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5 text-center sm:p-6">
        ...
        <p className="mt-2 flex-1 text-[14px] leading-relaxed text-black">{experience.blurb}</p>
